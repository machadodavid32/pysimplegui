# Para criar um executável, primeiro vamos instalar a biblioteca cx-freeza no cmd do windows digitando: pip install cx-freeze

# Na sequencia fazemos um novo arquivo chamado setup.py e neste arquivo faremos todo o processo

# Depois de completar o arquivo setup.py e fazer aqui
# o aplicativo, digite no terminal:
# python .\setup.py build
# o arquivo executavel será criado!
